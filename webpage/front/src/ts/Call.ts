...
export class ApiCall {
	 ...
	 */
	public async createEvent(the_event_name: string, the_event_description: string, the_day: string[], time_slots: number[]) : Promise<void> {
		this.actions = "Create-Event"
		this.event_name = the_event_name
		this.event_description = the_event_description
		this.day = `${the_day[1]}-${the_day[2]}-${the_day[0]}`
